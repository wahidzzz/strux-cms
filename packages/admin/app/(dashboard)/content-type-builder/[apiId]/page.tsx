  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* Sidebar */}
        <div className="col-span-1 border border-border rounded-xl bg-card overflow-hidden h-fit">
              ...
              <li key={type.apiId}>
                ...
                >
                  <span className="flex items-center gap-2 truncate">
                    ...
                    <span className="truncate">{type.singularName}</span>
                  </span>
                </Link>
              </li>
            ))}
        ...
        <div className="col-span-1 md:col-span-3 space-y-6">
          <SchemaForm initialSchema={isCreate ? null : currentSchema} isCreate={isCreate} />
        </div>
      </div>
    </div>
  )
